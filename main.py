...
two_D = np.array([[0, 1], [6, 2]])
three_D = np.array([[3, 4, 4], [3, 2, 2], [3, 1, 6]])
four_D = np.array([[2, 5, 3, 4], [6, 3, 0, 0], [5, 0, 0, 2], [0, 4, 5, 6]])
five_D = np.array([[3, 5, 6, 5, 4], [2, 0, 0, 3, 5], [5, 0, 3, 6, 2], [2, 2, 0, 6, 4], [2, 2, 5, 3, 6]])
